...
Scenario: controllo verbale
  ...
  E vedi testo "@alunno_sostegno_1:cognome,nome @voto_P_1A_28:unico #str(MAGGIORANZA) #str(Contrari) @docente_curricolare_1:cognome" in PDF analizzato in "4" righe
  E vedi testo "@alunno_sostegno_2:cognome,nome @voto_P_1A_38:unico #str(MAGGIORANZA) #str(Contrari) @docente_curricolare_1:cognome" in PDF analizzato in "4" righe
