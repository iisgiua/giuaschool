...
Funzionalità: quinto passo dello scrutinio del secondo periodo
  Per svolgere il quinto passo dello scrutinio del secondo periodo
  Come utente staff
  Bisogna controllare visualizzazione della pagina
  Bisogna controllare visualizzazione con la classe articolata
  Utilizzando "_scrutinioS5Fixtures.yml"
