...
Funzionalità: ottavo passo dello scrutinio finale
  Per svolgere il ottavo passo dello scrutinio finale
  Come utente staff
  Bisogna controllare visualizzazione della pagina
  Bisogna controllare visualizzazione con la classe articolata
  Utilizzando "_scrutinioF8Fixtures.yml"
...
Scenario: visualizzazione pagina passo 8
