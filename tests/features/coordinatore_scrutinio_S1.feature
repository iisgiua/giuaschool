...
Scenario: memorizzazione dati e passo successivo
  Data pagina attiva "coordinatore_scrutinio" con parametri:
    | classe        |
    | @classe_1A:id |
  Quando inserisci "01/04/2020" nel campo "scrutinio_data"
  ...
  E inserisci "31/03/2020" nel campo "scrutinio_lista_{{@docente_curricolare_1:id}}_surrogaData"
  ...
  Allora la sezione "#gs-main h2" contiene "Passo 1"
  E il campo "scrutinio_data" contiene "01/04/2020"
  ...
  E il campo "scrutinio_lista_{{@docente_curricolare_1:id}}_surrogaData" contiene "31/03/2020"
