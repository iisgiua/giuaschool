...
Scenario: Vista giornaliera area comune con lezioni comuni, religione, sostegno, sostituzione
  ...
  Allora vedi la tabella:
    ...
    | 5ª: 12:30 - 13:30 | Sostituzione                | @docente_nocattedra_1:nome,cognome                                   | @t_lezione_7:argomento,attivita | /^Aggiungi$/          |
...
Schema dello scenario: Vista giornaliera area gruppi con lezioni di gruppo, comuni, compresenza, sostegno
  ...
  Allora vedi la tabella:
    ...
    | 5ª: 12:30 - 13:30 | Gruppo: 3C-CHI Sostituzione | @docente_nocattedra_1:nome,cognome                                      | @t_lezione_13:argomento,attivita | /^Aggiungi$/ |
    | 6ª: 13:30 - 14:30 |                             |                                                                         |                                  | /^Aggiungi$/ |
  Esempi:
...
Scenario: Vista mensile area comune con lezioni
  ...
  Allora vedi nella riga "1" della tabella i dati:
    ...
    | Me 1 |        | Italiano | Inglese | Sostegno | Religione / Att. alt. Religione / Att. alt. Religione / Att. alt. | Sostituzione |    |    |    |
