...
Scenario: controllo verbale
  ...
  E vedi testo "@alunno_1A_1:cognome,nome @voto_S_1A_8:unico #str(UNANIMITÀ)" in PDF analizzato in una riga
...
Scenario: controllo verbale classe articolata
  ...
  E vedi testo "@alunno_3CAMB_1:cognome,nome @voto_S_3CAMB_8:unico #str(UNANIMITÀ)" in PDF analizzato in una riga
...
Scenario: controllo pagella
  ...
  E vedi poi testo "#str(Religione) #cas(@voto_S_1A_6:unico,20:21:22:23:24:25:26:27,NC:Insufficiente:Mediocre:Sufficiente:Discreto:Buono:Distinto:Ottimo,0) @voto_S_1A_6:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_1:nome #cas(@voto_S_1A_0:unico,0,NC,@voto_S_1A_0:unico) @voto_S_1A_0:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_2:nome #cas(@voto_S_1A_1:unico,0,NC,@voto_S_1A_1:unico) @voto_S_1A_1:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_3:nome #cas(@voto_S_1A_2:unico,0,NC,@voto_S_1A_2:unico) @voto_S_1A_2:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_4:nome #cas(@voto_S_1A_3:unico,0,NC,@voto_S_1A_3:unico) @voto_S_1A_3:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_itp_1:nome #cas(@voto_S_1A_0:unico,0,NC,@voto_S_1A_5:unico) @voto_S_1A_5:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_5:nome #cas(@voto_S_1A_4:unico,0,NC,@voto_S_1A_4:unico) @voto_S_1A_4:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_EDCIVICA:nome #cas(@voto_S_1A_7:unico,2,NC,@voto_S_1A_7:unico) @voto_S_1A_7:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_CONDOTTA:nome #cas(@voto_S_1A_8:unico,4,NC,@voto_S_1A_8:unico)" in PDF analizzato in una riga
...
Scenario: controllo pagella per classe articolata
  ...
  E vedi testo "3ª C-AMB" in PDF analizzato alla riga "4"
  E vedi poi testo "#str(MATERIA) #str(VOTO) #str(ORE)" in PDF analizzato in una riga
  E vedi poi testo "#str(Religione) #cas(@voto_S_3CAMB_5:unico,20:21:22:23:24:25:26:27,NC:Insufficiente:Mediocre:Sufficiente:Discreto:Buono:Distinto:Ottimo,0) @voto_S_3CAMB_5:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_1:nome #cas(@voto_S_3CAMB_0:unico,0,NC,@voto_S_3CAMB_0:unico) @voto_S_3CAMB_0:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_2:nome #cas(@voto_S_3CAMB_1:unico,0,NC,@voto_S_3CAMB_1:unico) @voto_S_3CAMB_1:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_3:nome #cas(@voto_S_3CAMB_2:unico,0,NC,@voto_S_3CAMB_2:unico) @voto_S_3CAMB_2:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_4:nome #cas(@voto_S_3CAMB_3:unico,0,NC,@voto_S_3CAMB_3:unico) @voto_S_3CAMB_3:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_itp_2:nome #cas(@voto_S_3CAMB_6:unico,0,NC,@voto_S_3CAMB_6:unico) @voto_S_3CAMB_6:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_curricolare_5:nome #cas(@voto_S_3CAMB_4:unico,0,NC,@voto_S_3CAMB_4:unico) @voto_S_3CAMB_4:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_EDCIVICA:nome #cas(@voto_S_3CAMB_7:unico,2,NC,@voto_S_3CAMB_7:unico) @voto_S_3CAMB_7:assenze" in PDF analizzato in una riga
  E vedi poi testo "@materia_CONDOTTA:nome #cas(@voto_S_3CAMB_8:unico,4,NC,@voto_S_3CAMB_8:unico)" in PDF analizzato in una riga
...
Scenario: controllo debiti per classe articolata
  ...
  E vedi poi testo "@materia_itp_2:nome #cas(@voto_S_3CAMB_6:unico,0,NC,@voto_S_3CAMB_6:unico) #str(Argomento...) #str(Studio) #str(individuale)" in PDF analizzato in "2" righe
