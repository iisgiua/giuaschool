...
Funzionalità: sesto passo dello scrutinio del secondo periodo
  Per svolgere il sesto passo dello scrutinio del secondo periodo
  Come utente staff
  Bisogna controllare visualizzazione della pagina
  Bisogna controllare visualizzazione con la classe articolata
  Utilizzando "_scrutinioS6Fixtures.yml"
