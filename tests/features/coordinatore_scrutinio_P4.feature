...
Funzionalità: quarto passo dello scrutinio del primo periodo
  Per svolgere il quarto passo dello scrutinio del primo periodo
  Come utente staff
  Bisogna controllare visualizzazione della pagina
  Bisogna controllare visualizzazione con la classe articolata
  Utilizzando "_scrutinioP4Fixtures.yml"
...
Scenario: visualizzazione riquadro inserimento lista voti Religione
  ...
  Allora la sezione "#gs-main #gs-modal-remote .modal-title.gs-h4" contiene "Religione Cattolica o attività alternative"
...
Scenario: memorizzazione dati e passo successivo
  ...
  E vedi la tabella "2" non ordinata senza intestazioni:
    ...
    | @alunno_1A_1:cognome+ +@alunno_1A_1:nome                   | #cas(@voto_P_1A_6:unico,20:21:22:23:24:25:26:27,NC:Insufficiente:Mediocre:Sufficiente:Discreto:Buono:Distinto:Ottimo,0)  | #cas(@voto_P_1A_0:unico,0,NC,@voto_P_1A_0:unico)   | #cas(@voto_P_1A_1:unico,0,NC,@voto_P_1A_1:unico)   | #cas(@voto_P_1A_2:unico,0,NC,@voto_P_1A_2:unico)   | #cas(@voto_P_1A_3:unico,0,NC,@voto_P_1A_3:unico)   | #cas(@voto_P_1A_5:unico,0,NC,@voto_P_1A_5:unico)   | #cas(@voto_P_1A_4:unico,0,NC,@voto_P_1A_4:unico)   | #cas(@voto_P_1A_7:unico,2,NC,@voto_P_1A_7:unico)   | #cas(@voto_P_1A_8:unico,4,NC,@voto_P_1A_8:unico)   | #med(@voto_P_1A_0:unico,@voto_P_1A_1:unico,@voto_P_1A_2:unico,@voto_P_1A_3:unico,@voto_P_1A_4:unico,@voto_P_1A_5:unico,@voto_P_1A_7:unico,@voto_P_1A_8:unico)         |
    | @alunno_1A_2:cognome+ +@alunno_1A_2:nome                   | NA                                                                                                                       | #cas(@voto_P_1A_10:unico,0,NC,@voto_P_1A_10:unico) | #cas(@voto_P_1A_11:unico,0,NC,@voto_P_1A_11:unico) | #cas(@voto_P_1A_12:unico,0,NC,@voto_P_1A_12:unico) | #cas(@voto_P_1A_13:unico,0,NC,@voto_P_1A_13:unico) | #cas(@voto_P_1A_15:unico,0,NC,@voto_P_1A_15:unico) | #cas(@voto_P_1A_14:unico,0,NC,@voto_P_1A_14:unico) | #cas(@voto_P_1A_17:unico,2,NC,@voto_P_1A_17:unico) | #cas(@voto_P_1A_18:unico,4,NC,@voto_P_1A_18:unico) | #med(@voto_P_1A_10:unico,@voto_P_1A_11:unico,@voto_P_1A_12:unico,@voto_P_1A_13:unico,@voto_P_1A_14:unico,@voto_P_1A_15:unico,@voto_P_1A_17:unico,@voto_P_1A_18:unico) |
    | @alunno_sostegno_1:cognome+ +@alunno_sostegno_1:nome       | Ottimo                                                                                                                   | 10                                                 | #cas(@voto_P_1A_21:unico,0,NC,@voto_P_1A_21:unico) | #cas(@voto_P_1A_22:unico,0,NC,@voto_P_1A_22:unico) | #cas(@voto_P_1A_23:unico,0,NC,@voto_P_1A_23:unico) | #cas(@voto_P_1A_25:unico,0,NC,@voto_P_1A_25:unico) | #cas(@voto_P_1A_24:unico,0,NC,@voto_P_1A_24:unico) | 10                                                 | 10                                                 | #med(10,@voto_P_1A_21:unico,@voto_P_1A_22:unico,@voto_P_1A_23:unico,@voto_P_1A_24:unico,@voto_P_1A_25:unico,10,10)                                                    |
    | @alunno_sostegno_2:cognome+ +@alunno_sostegno_2:nome       | #cas(@voto_P_1A_36:unico,20:21:22:23:24:25:26:27,NC:Insufficiente:Mediocre:Sufficiente:Discreto:Buono:Distinto:Ottimo,0) | #cas(@voto_P_1A_30:unico,0,NC,@voto_P_1A_30:unico) | #cas(@voto_P_1A_31:unico,0,NC,@voto_P_1A_31:unico) | #cas(@voto_P_1A_32:unico,0,NC,@voto_P_1A_32:unico) | #cas(@voto_P_1A_33:unico,0,NC,@voto_P_1A_33:unico) | #cas(@voto_P_1A_35:unico,0,NC,@voto_P_1A_35:unico) | #cas(@voto_P_1A_34:unico,0,NC,@voto_P_1A_34:unico) | #cas(@voto_P_1A_37:unico,2,NC,@voto_P_1A_37:unico) | #cas(@voto_P_1A_38:unico,4,NC,@voto_P_1A_38:unico) | #med(@voto_P_1A_30:unico,@voto_P_1A_31:unico,@voto_P_1A_32:unico,@voto_P_1A_33:unico,@voto_P_1A_34:unico,@voto_P_1A_35:unico,@voto_P_1A_37:unico,@voto_P_1A_38:unico) |
    | @alunno_alternativa_1:cognome+ +@alunno_alternativa_1:nome | #cas(@voto_P_1A_46:unico,20:21:22:23:24:25:26:27,NC:Insufficiente:Mediocre:Sufficiente:Discreto:Buono:Distinto:Ottimo,0) | #cas(@voto_P_1A_40:unico,0,NC,@voto_P_1A_40:unico) | #cas(@voto_P_1A_41:unico,0,NC,@voto_P_1A_41:unico) | #cas(@voto_P_1A_42:unico,0,NC,@voto_P_1A_42:unico) | #cas(@voto_P_1A_43:unico,0,NC,@voto_P_1A_43:unico) | #cas(@voto_P_1A_45:unico,0,NC,@voto_P_1A_45:unico) | #cas(@voto_P_1A_44:unico,0,NC,@voto_P_1A_44:unico) | #cas(@voto_P_1A_47:unico,2,NC,@voto_P_1A_47:unico) | #cas(@voto_P_1A_48:unico,4,NC,@voto_P_1A_48:unico) | #med(@voto_P_1A_40:unico,@voto_P_1A_41:unico,@voto_P_1A_42:unico,@voto_P_1A_43:unico,@voto_P_1A_44:unico,@voto_P_1A_45:unico,@voto_P_1A_47:unico,@voto_P_1A_48:unico) |
