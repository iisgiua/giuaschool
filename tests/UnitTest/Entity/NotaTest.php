...
class NotaTest extends EntityTestCase {
 ...
 /**
  ...
  public function testMethods() {
    ...
    // addAlunni
    $existent->setAlunni(new ArrayCollection());
  ...
  public function testValidation() {
    ...
    // data
    $property = $this->getPrivateProperty(Nota::class, 'data');
    ...
    // testo
    $property = $this->getPrivateProperty(Nota::class, 'testo');
    ...
    // classe
    $property = $this->getPrivateProperty(Nota::class, 'classe');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
    ...
    // docente
    $property = $this->getPrivateProperty(Nota::class, 'docente');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
