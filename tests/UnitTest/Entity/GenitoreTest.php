...
class GenitoreTest extends EntityTestCase {
 ...
 /**
    ...
    for ($i = 0; $i < 5; $i++) {
      ...
      foreach ($this->fields as $field) {
        $data[$i][$field] =
          ...
          ($field == 'rappresentante' ? $this->faker->randomElements(['I', 'C'], 1) :
  ...
  public function testMethods() {
    ...
    $existent->setRappresentante(['C', 'I']);
    $this->assertSame(['C', 'I', 'N'], $existent->getCodiceFunzioni(), $this->entity.'::getCodiceFunzioni');
    $existent->setRspp(true);
    $this->assertSame(['C', 'I', 'S', 'N'], $existent->getCodiceFunzioni(), $this->entity.'::getCodiceFunzioni');
    // setRappresentante
    $existent->setRappresentante(['A', 'I', 'C', 'P']);
