...
/**
 * Unit test dell'entità Genitore
 *
 * @author Antonello Dessì
 */
class GenitoreTest extends EntityTestCase {
 ...
 /**
  ...
  protected function setUp(): void {
    // nome dell'entità
    $this->entity = Genitore::class;
    // campi da testare
    $this->fields = ['giustificaOnline', 'alunno', 'username', 'password', 'email', 'token', 'tokenCreato', 'prelogin', 'preloginCreato', 'abilitato', 'spid', 'ultimoAccesso', 'otp', 'ultimoOtp', 'dispositivo', 'nome', 'cognome', 'sesso', 'dataNascita', 'comuneNascita', 'provinciaNascita', 'codiceFiscale', 'citta', 'provincia', 'indirizzo', 'numeriTelefono', 'notifica', 'rappresentante', 'rspp', 'loginSpeciale', 'dati'];
    $this->noStoredFields = [];
    $this->generatedFields = ['id', 'creato', 'modificato'];
    // fixture da caricare
    $this->fixtures = '_entityTestFixtures';
    // SQL read
    $this->canRead = ['gs_utente' => ['giustifica_online', 'alunno_id', 'id', 'creato', 'modificato', 'username', 'password', 'email', 'token', 'token_creato', 'prelogin', 'prelogin_creato', 'abilitato', 'spid', 'ultimo_accesso', 'otp', 'ultimo_otp', 'dispositivo', 'nome', 'cognome', 'sesso', 'data_nascita', 'comune_nascita', 'provincia_nascita', 'codice_fiscale', 'citta', 'provincia', 'indirizzo', 'numeri_telefono', 'notifica', 'tipo', 'segreteria', 'sede_id', 'responsabile_bes', 'responsabile_bes_sede_id', 'bes', 'note_bes', 'autorizza_entrata', 'autorizza_uscita', 'note', 'frequenza_estero', 'religione', 'credito3', 'credito4', 'richiesta_certificato', 'foto', 'classe_id', 'ruolo', 'rspp', 'rappresentante', 'login_speciale', 'dati']];
    // SQL write
    $this->canWrite = ['gs_utente' => ['giustifica_online', 'alunno_id', 'id', 'creato', 'modificato', 'username', 'password', 'email', 'token', 'token_creato', 'prelogin', 'prelogin_creato', 'abilitato', 'spid', 'ultimo_accesso', 'otp', 'ultimo_otp', 'dispositivo', 'nome', 'cognome', 'sesso', 'data_nascita', 'comune_nascita', 'provincia_nascita', 'codice_fiscale', 'citta', 'provincia', 'indirizzo', 'numeri_telefono', 'notifica', 'tipo', 'segreteria', 'sede_id', 'responsabile_bes', 'responsabile_bes_sede_id', 'bes', 'note_bes', 'autorizza_entrata', 'autorizza_uscita', 'note', 'frequenza_estero', 'religione', 'credito3', 'credito4', 'richiesta_certificato', 'foto', 'classe_id', 'ruolo', 'rspp', 'rappresentante', 'login_speciale', 'dati']];
    // SQL exec
  ...
  public function testMethods() {
    ...
    // getCodiceRuolo
    $this->assertSame('G', $existent->getCodiceRuolo(), $this->entity.'::getCodiceRuolo');
    // controllaRuolo
    ...
    $existent->setRappresentante(['L', 'I']);
    $this->assertSame(['L', 'I', 'N'], $existent->getCodiceFunzioni(), $this->entity.'::getCodiceFunzioni');
    $existent->setRspp(true);
    $this->assertSame(['L', 'I', 'S', 'N'], $existent->getCodiceFunzioni(), $this->entity.'::getCodiceFunzioni');
  }
