...
class DocenteTest extends EntityTestCase {
 ...
 /**
    ...
    for ($i = 0; $i < 5; $i++) {
      ...
      foreach ($this->fields as $field) {
        $data[$i][$field] =
          ...
          ($field == 'rappresentante' ? $this->faker->randomElements(['I', 'R'], 1) :
  ...
  public function testMethods() {
    ...
    // setRappresentante
    $existent->setRappresentante(['A', 'I', 'C', 'R']);
    $this->assertSame(['I', 'R'], $existent->getRappresentante(), $this->entity.'::setRappresentante');
  }
