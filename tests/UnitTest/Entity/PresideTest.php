 ...
 */
class PresideTest extends EntityTestCase {
 ...
 /**
  ...
  public function testMethods() {
    ...
    $this->assertSame([], $existent->getRappresentante(), $this->entity.'::setRappresentante');
  }
