...
class EntrataTest extends DatabaseTestCase {
  ...
  public function testProperties() {
    ...
    for ($i = 0; $i < 5; $i++) {
      ...
      sleep(1);
      $data[$i]['docente'] = $this->getReference("docente_2");
  ...
  public function testValidation() {
    ...
    // data
    $property = $this->getPrivateProperty('App\Entity\Entrata', 'data');
    ...
    // ora
    $property = $this->getPrivateProperty('App\Entity\Entrata', 'ora');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
    ...
    // alunno
    $property = $this->getPrivateProperty('App\Entity\Entrata', 'alunno');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
    ...
    // docente
    $property = $this->getPrivateProperty('App\Entity\Entrata', 'docente');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
