...
class EntrataTest extends EntityTestCase {
  ...
  public function __construct() {
    parent::__construct();
    // nome dell'entità
    $this->entity = \App\Entity\Entrata::class;
    // campi da testare
  ...
  public function testValidation() {
    ...
    // data
    $property = $this->getPrivateProperty(\App\Entity\Entrata::class, 'data');
    ...
    // ora
    $property = $this->getPrivateProperty(\App\Entity\Entrata::class, 'ora');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
    ...
    // alunno
    $property = $this->getPrivateProperty(\App\Entity\Entrata::class, 'alunno');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
    ...
    // docente
    $property = $this->getPrivateProperty(\App\Entity\Entrata::class, 'docente');
    $property->setValue($existent, null);
    $err = $this->val->validate($existent);
    ...
    // unique
    $newObject = new \App\Entity\Entrata();
    foreach ($this->fields as $field) {
