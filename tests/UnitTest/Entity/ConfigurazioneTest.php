 ...
 */
class ConfigurazioneTest extends EntityTestCase {
 ...
 /**
  ...
  protected function setUp(): void {
    // nome dell'entità
    $this->entity = Configurazione::class;
    // campi da testare
  ...
  public function testValidation() {
    ...
    // categoria
    $property = $this->getPrivateProperty(Configurazione::class, 'categoria');
    ...
    // parametro
    $property = $this->getPrivateProperty(Configurazione::class, 'parametro');
    $property->setValue($existent, '');
    $err = $this->val->validate($existent);
