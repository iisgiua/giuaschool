...
/**
 * Unit test dell'entità ComunicazioneUtente
 *
 * @author Antonello Dessì
 */
class ComunicazioneUtenteTest extends EntityTestCase {
 ...
 /**
  ...
  protected function setUp(): void {
    // nome dell'entità
    $this->entity = ComunicazioneUtente::class;
    // campi da testare
    $this->fields = ['comunicazione', 'utente', 'letto', 'firmato'];
    $this->noStoredFields = [];
    $this->generatedFields = ['id', 'creato', 'modificato'];
    // fixture da caricare
    $this->fixtures = '_entityTestFixtures';
    // SQL read
    $this->canRead = ['gs_comunicazione_utente' => ['id', 'creato', 'modificato', 'comunicazione_id', 'utente_id', 'letto', 'firmato'],
      'gs_comunicazione' => '*',
      'gs_sede' => '*'];
    // SQL write
    $this->canWrite = ['gs_comunicazione_utente' => ['id', 'creato', 'modificato', 'comunicazione_id', 'utente_id', 'letto', 'firmato']];
    // SQL exec
  ...
  public function testMethods() {
    ...
    // toString
    $this->assertSame(''.$existent->getComunicazione().' - '.$existent->getUtente(),
