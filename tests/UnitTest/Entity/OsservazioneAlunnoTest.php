...
/**
 * Unit test dell'entità OsservazioneAlunno
 *
 * @author Antonello Dessì
 */
class OsservazioneAlunnoTest extends EntityTestCase {
 ...
 /**
  ...
  protected function setUp(): void {
    // nome dell'entità
    $this->entity = OsservazioneAlunno::class;
    // campi da testare
  ...
  public function testMethods() {
    ...
    // toString
    $this->assertSame($existent->getData()->format('d/m/Y').' - '.$existent->getCattedra().' - '.$existent->getAlunno().': '.$existent->getTesto(), (string) $existent, $this->entity.'::toString');
  }
  ...
  public function testValidation() {
    ...
    $property = $this->getPrivateProperty(OsservazioneAlunno::class, 'alunno');
