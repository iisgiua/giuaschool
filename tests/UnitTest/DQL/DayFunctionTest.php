...
/**
 * Unit test dell'estensione DQL: Day
 *
 * @author Antonello Dessì
 */
class DayFunctionTest extends DatabaseTestCase {
  ...
  public function testParse(): void {
    ...
    $this->assertSame("[Syntax Error] line 0, col 11: Error: Expected Literal, got ')'", $exception);
  ...
  public function testSql(): void {
    $query = new Query($this->em);
    $query->setDQL("SELECT DAY(c.creato) FROM App\Entity\Configurazione c");
    $this->assertSame("SELECT DAY(g0_.creato) AS sclr_0 FROM gs_configurazione g0_", $query->getSql());
  }
