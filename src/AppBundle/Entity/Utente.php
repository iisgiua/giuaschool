 ...
 * @UniqueEntity(fields="email", message="field.unique", entityClass="AppBundle\Entity\Utente")
 * @UniqueEntity(fields="codiceFiscale", message="field.unique", entityClass="AppBundle\Entity\Utente")
 */
