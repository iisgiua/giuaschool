...
INSERT INTO `gs_configurazione` VALUES (204,NOW(),NOW(),'SCUOLA','giorni_festivi_istituto','Indica i giorni festivi settimanali per l\'intero istituto<br>[lista separata da virgole nel formato: 0=domenica, 1=luned&igrave;, ... 6=sabato]','0',0);
INSERT INTO `gs_configurazione` VALUES (205,NOW(),NOW(),'SCUOLA','giorni_festivi_classi','Indica i giorni festivi settimanali per singole classi (per gestire settimana corta anche per solo alcune classi)<br>[lista separata da virgole nel formato \'giorno:classe\'; giorno: 0=domenica, 1=luned&igrave;, ... 6=sabato; classe: 1A, 2A, ...]','',0);
INSERT INTO `gs_configurazione` VALUES (  6,NOW(),NOW(),'ACCESSO','id_provider','Se presente, indica l\'uso di un identity provider esterno (es. SSO su Google)<br>[testo]','',0);
INSERT INTO `gs_configurazione` VALUES (  8,NOW(),NOW(),'ACCESSO','id_provider_dominio','Nel caso si utilizzi un identity provider esterno, indica il dominio di posta predefinito per le email degli utenti (usato nell\'importazione)<br>[testo]','',0);
INSERT INTO `gs_configurazione` VALUES ( 10,NOW(),NOW(),'ACCESSO','id_provider_tipo','Nel caso si utilizzi un identity provider esterno, indica il dominio di posta predefinito per le email degli utenti (usato nell\'importazione)<br>[testo]','',0);
INSERT INTO `gs_configurazione` VALUES (  9,NOW(),NOW(),'ACCESSO','spid','Indica la modalit&agrave; dell\'accesso SPID: \'no\' = non utilizzato, \'si\' = utilizzato, \'validazione\' = utilizzato in validazione.<br>[si|no|validazione]', 'no', 1);
