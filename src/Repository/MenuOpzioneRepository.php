...
class MenuOpzioneRepository extends EntityRepository {
    ...
    public function breadcrumb($url, Utente $utente=null, RequestStack $reqstack) {
      ...
      $dati = $this->createQueryBuilder('o')
        ...
        ->leftJoin('App\Entity\MenuOpzione', 'o2', 'WITH', 'o.menu=o2.sottoMenu AND INSTR(o2.ruolo, :ruolo) > 0')
        ->leftJoin('App\Entity\MenuOpzione', 'o3', 'WITH', 'o2.menu=o3.sottoMenu AND INSTR(o3.ruolo, :ruolo) > 0')
