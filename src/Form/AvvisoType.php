    ...
    if ($options['form_mode'] == 'generico') {
      ...
      $builder
        ...
        ->add('destinatariAta', ChoiceType::class, ['label' => 'label.destinatari_ATA',
					...
					'label_attr' => ['class' => 'gs-checkbox-inline gs-mr-5 gs-pr-5'],
					'required' => false])
        ->add('destinatariSpeciali', ChoiceType::class, ['label' => 'label.destinatari_speciali',
        ...
        ->add('destinatari', ChoiceType::class, ['label' => 'label.destinatari',
					...
					'label_attr' => ['class' => 'gs-checkbox-inline gs-mr-5 gs-pr-5'],
					'required' => false])
        ->add('filtroTipo', ChoiceType::class, ['label' => 'label.filtro_tipo',
					...
					'required' => false])
				->add('filtro', HiddenType::class, ['label' => false,
					'required' => false])
      ...
      $builder
        ->add('data', DateType::class, ['label' => $options['form_mode'] == 'verifica' ? 'label.data_verifica' : 'label.data_compito',
					'widget' => 'single_text',
					'html5' => false,
					'attr' => ['widget' => 'gs-picker'],
					'format' => 'dd/MM/yyyy',
					'required' => true])
        ->add('cattedra', ChoiceType::class, ['label' => $options['form_mode'] == 'verifica' ? 'label.cattedra_verifica' : 'label.cattedra_compito',
					'choices' => $options['values'][0],
					'expanded' => false,
					'multiple' => false,
					...
					'choice_translation_domain' => false,
					'required' => true])
        ->add('materia_sostegno', HiddenType::class, ['label' => false,
